...
import car4 from '../public/image/car4.jpg'; // Add new car images
...
const cars = [
  ...
  { id: '4', name: 'Tayto Car', image: car4 }, // New car
  { id: '5', name: 'Sports Car', image: car5 }, // New car
  { id: '6', name: 'Electric Car', image: car6 }, // New car
];
      ...
      <div className={styles.carList}>
        {cars.map((car) => (
          <div key={car.id} className={styles.carCard}>
            <Link href={`/showroom/${car.id}`} passHref className={styles.imageWrapper}>
              <div>
                <Image 
                  src={car.image} 
                  alt={car.name} 
